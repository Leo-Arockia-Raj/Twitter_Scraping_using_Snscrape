...
def data_upload(search_word_fm, tweets_df_fm, db_host='localhost', db_port=27017, user_database='twitter_db',
                user_collection='twitter_search_collection'):
    """
    ...
    """
    client = MongoClient(db_host, db_port)  # creates a connection with port 27017.
    db = client[user_database]  # Creates a database named "twitter_db".
    collection = db[user_collection]  # Creates a collection "twitter_search_collection" in twitter_db.
